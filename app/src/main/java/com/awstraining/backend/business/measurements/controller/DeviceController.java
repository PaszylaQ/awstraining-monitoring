...
class DeviceController implements DeviceIdApi {
    ...
    public ResponseEntity<Measurement> publishMeasurements(final String deviceId, final Measurement measurement) {
        ...
        methodCounter("publishMeasurements.counter");
    ...
    private void methodCounter(String builder){
        String methodName = new Object(){}.getClass().getEnclosingMethod().getName();

        Counter counter = Counter.builder(builder).tag("method", methodName).register(meterRegistry);
